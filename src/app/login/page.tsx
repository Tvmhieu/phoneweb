            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="d-flex justify-content-between align-items-center mb-4">
                <div className="form-check">
                    ...
                    <label className="form-check-label small" htmlFor="rememberMe">Ghi nhớ đăng nhập</label>
                </div>
                <Link href="#" className="small text-primary text-decoration-none">Quên mật khẩu?</Link>
              </div>
              ...
              <div className="text-center">
                <span className="text-muted small">Chưa có tài khoản đối tác?</span>
                <Link href="/register" className="text-primary ms-2 fw-bold text-decoration-none small">Đăng ký ngay</Link>
              </div>
            </form>
          </div>
        </div>
